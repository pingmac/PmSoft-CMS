...
namespace PmSoft.Caching
{
    ...
    public class NewtonsoftSerializer : ISerializer
    {
        ...
        public byte[] Serialize(object item)
        {
            ...
            var jsonString = JsonConvert.SerializeObject(item, type, Formatting.None, settings);
        ...
        {
            var type = item.GetType();
            var jsonString = await Task.Factory.StartNew(() => JsonConvert.SerializeObject(item, type, Formatting.None, settings));
            return encoding.GetBytes(jsonString);
        }
