...
namespace PetaPoco
{
    ...
    /// </summary>
    public interface IDatabase : IDisposable, IQuery, IAlterPoco, IExecute, ITransactionAccessor, IStoredProc, IConnection, IExtend
#if ASYNC
                                 , IQueryAsync, IExecuteAsync, IStoredProcAsync, IAlterPocoAsync, IExtendAsync
#endif
    {
        /// <summary>
